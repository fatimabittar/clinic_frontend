...
import wtspbtn from "../../images/sendwtspbtn.png";
import wtspwdget from "../../images/whatsappwidget.png";
        ...
        <div className="ewChat">
          ...
          <div className="ewChatInput">
            <input
              ...
              id="message"
              ref={messageRef}
              value="Hi, I want to get more details !!!"
            ></input>

            <div className="wtspbtn">
              <a href={link} target="_blank" rel="noreferrer">
                <button onClick={generateLink}>
                  <img
                    src={wtspbtn}
                    className="wtspbtnlogo"
                    alt="wtspbtn"
                  ></img>
                </button>
              </a>
